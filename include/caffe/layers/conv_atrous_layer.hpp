 ...
 */
    ...
    class ConvolutionAtrousLayer : public Layer<Dtype> {
    public:
        /**
         ...
         */
        explicit ConvolutionAtrousLayer(const LayerParameter& param)
        : Layer<Dtype>(param) {}
        ...
        virtual inline const char* type() const { return "ConvolutionAtrous"; }
